...
import { TransactionFilter, TransactionType, getTransactions } from "@/lib/api/transactions";
                                            ...
                                            <TableRow key={transaction.id}>
                                                ...
                                                <TableBodyCell>
                                                    {transaction.subscriptionId != null ? (
                                                        <>Subscription</>
                                                    ) : (transaction.transfersFrom.length > 0 || transaction.transfersTo.length > 0) ? (
                                                        <>Transfer</>
                                                    ) : (
                                                        <>Payment</>
                                                    )}
                                                ...
                                                <TableBodyCell>
                                                    {
                                                        (transaction.transfersFrom.length > 0 || transaction.transfersTo.length > 0) ? (
                                                            <span className="text-violet-500">
                                                                {
                                                                    transaction.transfersTo.length > 0 ? (
                                                                        <></>
                                                                    ) : (
                                                                        <>-</>
                                                                    )
                                                ...
                                                <TableBodyCell>
                                                    <Menu>
                                                        ...
                                                        <MenuItems anchor="bottom" transition className="absolute p-2 right-0 z-10 mt-2 w-32 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 transition focus:outline-none data-[closed]:scale-95 data-[closed]:transform data-[closed]:opacity-0 data-[enter]:duration-100 data-[leave]:duration-75 data-[enter]:ease-out data-[leave]:ease-in">
                                                            {
                                                                ((selectedTransaction?.transfersFrom.length ?? 0) >= 1 || (selectedTransaction?.transfersTo.length ?? 0) >= 1) ? (
                                                                    <>
                                                                        <MenuItem>
                                                                            ...
                                                                            } transfer={(selectedTransaction?.transfersFrom[0] || selectedTransaction?.transfersTo[0]) as any} accounts={accounts} categories={categories} />
                                                                        </MenuItem>
                                                                        {
                                                                            <MenuItem>
                                                                                ...
                                                                                } transfer={(selectedTransaction?.transfersFrom[0] || selectedTransaction?.transfersTo[0]) as any} />
                                                                            </MenuItem>
                                                                        }
                                                                    </>
                                                                ) : (
